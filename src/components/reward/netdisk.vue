        ...
        <keep-alive>
          <a-col :xl="4" :lg="24" :md="24" :sm="24" :xs="24">
            ...
            <div style="background-color:#fefefe;width:101%;height:100%;">
              ...
              <div class="mod-logo" style="font-size: 1.30rem; margin-left: 0.9rem; padding-top: 0.7rem;">
                <img style="float:left;margin-left:0px;margin-right:10px;" src="https://img.weiyun.com/vipstyle/nr/box/img/favicon.ico?max_age=31536000" />
                云文档
              </div>

              <a-input-search placeholder="搜索全部" style="width: 200px; margin-top: 15px; margin-left: 10px; margin-bottom: 0px;" @search="onSearch" />

              <a-menu style="width:101%;height:100%;margin-top:20px;" mode="vertical" @click="handleClick">
                <a-menu-item key="1">
                  <a-icon type="mail" />
                  最近
                </a-menu-item>
