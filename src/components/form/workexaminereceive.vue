      ...
      <div class="weui-cells" style="margin-top:0px;">
        ...
        <div class="" id="scanCell" style="padding: 8px 10px 4px 10px;">
          <van-row>
            ...
            <van-col span="8" style="text-align: center;font-size:1.15rem;">工程巡检</van-col>
            <van-col span="8"></van-col>
          </van-row>
        </div>
...
export default {
    ...
    methods: {
      ...
      async handleApply() {
        ...
        // 返回预览URL
        const receiveURL = encodeURIComponent(`${window.location.protocol}//${window.location.host}/#/app/goodsview?id=${id}&statustype=office&type=${type}&role=front`);
