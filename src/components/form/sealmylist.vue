    ...
    <section>
      ...
      <div class="wechat-list">
        ...
        <template v-show="tabname == 1 && !loading && !isLoading">
            <van-empty v-if="tabname == 1 && initContractList && initContractList.length == 0 " description="暂无数据" />
        ...
        <template v-show="tabname == 2 && !loading && !isLoading">
            <van-empty v-if="tabname == 2 && sealContractList && sealContractList.length == 0 " description="暂无数据" />
        ...
        <template v-show="tabname == 6 && !loading && !isLoading">
            <van-empty v-if="tabname == 6 && failContractList && failContractList.length == 0 " description="暂无数据" />
        ...
        <template v-show="tabname == 7 && !loading && !isLoading">
            <van-empty v-if="tabname == 7 && endContractList && endContractList.length == 0 " description="暂无数据" />
