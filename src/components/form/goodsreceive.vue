...
export default {
    ...
    methods: {
      ...
      async handleApply() {
        ...
        let countInfo = await Betools.manage.queryTableData('v_goods_receive_count' , `_where=(create_by,eq,${userinfo.username})`);
        ...
        // 返回预览URL
        const receiveURL = encodeURIComponent(`${window.BECONFIG.domain.replace('www','wechat')}/#/app/goodsview?id=${id}&statustype=office&type=${type}&role=front`);
