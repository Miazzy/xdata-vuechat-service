...
export default {
    ...
    methods: {
      ...
      async queryInfo(){
        ...
        //获取最近6个月的已归档记录
        this.failContractList = await manageAPI.queryTableData('bs_seal_regist' , `_where=(status,eq,已作废)~and(create_time,gt,${month})${sealTypeSql}&_sort=-create_time&_p=0&_size=1000`);
